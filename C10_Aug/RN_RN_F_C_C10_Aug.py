...
parser.add_argument('--dataset_path', type=str, default='/home/jtcai/SharedSSD/myCode/Student/data/')

parser.add_argument('--t_name', default='WRN')  # [RN, WRN, PYN, VGG]
parser.add_argument('--t_depth', type=int, default=16)  # [RN, WRN, VGG]
parser.add_argument('--t_widen_factor', type=int, default=2)  # [WRN]
parser.add_argument('--t_alpha', type=int, default=240)  # for pyramidnet

parser.add_argument('--s_name', default='WRN')
...
parser.add_argument('--pseudo_label_type', default='Ensemble[Aug-1]')  # [`Ensemble`, `New`, `Old`]

using_one_train = False
...
def train1(train_loader, nets, optimizers, epoch):
    ...
    for idx, (img, target) in enumerate(train_loader, start=1):
        ...
        for jj in range(inter_intra_step):
            ...
            pseudo_loss = pseudo_loss + inter_t1 + inter_t2
...
def train2(train_loader, nets, optimizers, epoch):
    ...
    for idx, (img, target) in enumerate(train_loader, start=1):
        ...
        for jj in range(pseudo_step):
            ...
            pseudo_loss = pseudo_loss + inter_s1 + inter_s2
